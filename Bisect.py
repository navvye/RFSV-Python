from scipy import *
import numpy as np
def bisect(target, targetfunction, start=None, bounds=None, tols=[0.01, 0.01], maxiter=200):        
    ...
    def isAnswerFound(y, x, tols, a, b, target, targetfunction):
        ...
        #return bool(isBoundsWithinTolerence(a, b, tols[0], target, targetfunction))
